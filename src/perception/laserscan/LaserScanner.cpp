...
void LaserScanner::printLaserScanRanges(sensor_msgs::LaserScan::ConstPtr LaserScanMsg)
{
  ...
  cout << setw(20) << "Frame_ID: " << LaserScanMsg->header.frame_id << endl
       << endl;

  /** sensor_msgs/LaserScan.msg */
  cout << "LaserScan Info (sensor_msgs/LaserScan.msg) " << endl;
  cout << setw(20) << "Size: " << LaserScanMsg->ranges.size() << endl;
  cout << setw(20) << "Angle increment: "
       << "[" << LaserScanMsg->angle_increment << " rad, " << radian2degree(LaserScanMsg->angle_increment) << " deg]" << endl; // angular distance between measurements [rad]
  cout << setw(20) << "Minimum angle: "
       << "[" << LaserScanMsg->angle_min << " rad, " << radian2degree(LaserScanMsg->angle_min) << " deg]" << endl; // start angle of the scan [rad]
  cout << setw(20) << "Maximum angle: "
       << "[" << LaserScanMsg->angle_max << " rad, " << radian2degree(LaserScanMsg->angle_max) << " deg]" << endl; // end angle of the scan [rad]
  ...
  cout << setw(20) << "Time increment: " << LaserScanMsg->scan_time << " seconds" << endl
       << endl; // time between measurements [seconds] - if your scanner is moving, this will be used in interpolating position of 3d points
